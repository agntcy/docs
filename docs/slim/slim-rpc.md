...
[example
protobuf](https://github.com/agntcy/slim/blob/slim-v1.0.0/data-plane/python/integrations/slimrpc/slimrpc/examples/simple/example.proto)
...
[example](https://github.com/agntcy/slim/tree/slim-v1.0.0/data-plane/python/integrations/slimrpc/slimrpc/examples/simple)
folder.
...
[example_pb2.py](https://github.com/agntcy/slim/blob/slim-v1.0.0/data-plane/python/integrations/slimrpc/slimrpc/examples/simple/types/example_pb2.py)
and
[example_pb2_slimrpc.py](https://github.com/agntcy/slim/blob/slim-v1.0.0/data-plane/python/integrations/slimrpc/slimrpc/examples/simple/types/example_pb2_slimrpc.py).
...
[server.py](https://github.com/agntcy/slim/blob/slim-v1.0.0/data-plane/python/integrations/slimrpc/slimrpc/examples/simple/server.py).
...
[client.py](https://github.com/agntcy/slim/blob/slim-v1.0.0/data-plane/python/integrations/slimrpc/slimrpc/examples/simple/client.py),
...
[channel.py](https://github.com/agntcy/slim/blob/slim-v1.0.0/data-plane/python/integrations/slimrpc/slimrpc/channel.py):
