...
<nav class="agntcy-connect__links" aria-label="Community links">
  <a
    class="agntcy-connect__link"
    href="https://blogs.agntcy.org"
    target="_blank"
    rel="noopener noreferrer"
  >
    <svg class="agntcy-connect__icon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
  ...
  <a
    class="agntcy-connect__link"
    href="https://join.slack.com/t/agntcy/shared_invite/zt-3xozr6nzq-i6LXv2P8l2kVW4_Prnny2w"
    target="_blank"
    rel="noopener noreferrer"
  >
    <svg class="agntcy-connect__icon" viewBox="0 0 24 24" aria-hidden="true">
